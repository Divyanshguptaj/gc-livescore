...
export default function NotFound() {
  ...
  return (
    <div className="flex h-[90%] w-screen justify-center items-center bg-black overflow-x-hidden relative">
      <div id="message" className="flex flex-col justify-center items-center w-[100%] h-[100%] absolute z-2 text-black">
        <div id="m1" className="text-[35px] font-semibold my-1">Page Not Found</div>
        <div id="m2" className="text-[80px] font-bold my-1">404</div>
        <div id="m3" className="text-[15px] w-1/2 min-w-[40%] text-center my-1">
        The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.
        </div>
        {/* <div id="m4" className="text-[15px] w-1/2 min-w-[40%] text-center my-1">
          Our "experts" are trying to fix the problem, please stand by.
        </div> */}
      </div>
      <div id="charactersDiv" className="absolute w-[100%] h-[100%] z-2"></div>
      <canvas id="canvas" className="absolute w-[100%] h-[100%]"></canvas>
  </div>
  );
}
